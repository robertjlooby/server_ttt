...
(function() {
  describe("TicTacToe.resetBoard", function() {
    ...
    xit("should reset TicTacToe.boardState to an empty board", function() {
      TicTacToe.boardState = "blahblah";
      TicTacToe.resetBoard("X");
      return expect(TicTacToe.boardState).toBe("_________");
    });
    xit("should reset TicTacToe.buttonsEnabled to false", function() {
      TicTacToe.buttonsEnabled = true;
      TicTacToe.resetBoard("X");
      return expect(TicTacToe.buttonsEnabled).toBe(false);
    });
    return xit("should pass event handler to display.resetBoard which calls makeMove", function() {
      var eventFn;
  ...
  describe("TicTacToe.displayForm", function() {
    return xit("passes an event handler to call initializeGame to  display.displayForm()", function() {
  ...
  describe("TicTacToe.disable/enable Buttons", function() {
    ...
    xit("buttons should do nothing by default", function() {
      eventFn(0);
      return expect(TicTacToe.makeMove).not.toHaveBeenCalled();
    });
    xit("should enable all buttons", function() {
      TicTacToe.enableButtons();
      eventFn(0);
      return expect(TicTacToe.makeMove).toHaveBeenCalledWith("X", "_________", 0);
    });
    return xit("should be able to disable buttons again", function() {
      TicTacToe.enableButtons();
  ...
  describe("TicTacToe.getNewBoardState", function() {
    return xit("should replace first element", function() {
      return expect(TicTacToe.getNewBoardState("X", "__O______", 0)).toBe("X_O______");
    });
  });

  describe("TicTacToe.getNewBoardState", function() {
    xit("should replace first element", function() {
      return expect(TicTacToe.getNewBoardState("X", "__O______", 0)).toBe("X_O______");
    });
    xit("should replace an element in the middle", function() {
      return expect(TicTacToe.getNewBoardState("O", "X_OX_____", 6)).toBe("X_OX__O__");
    });
    return xit("should replace an element at the end", function() {
  ...
  describe("TicTacToe.updateBoardHuman", function() {
    ...
    xit("should call display.makeMove with the given marker/cell", function() {
      TicTacToe.updateBoardHuman("X", "_________", 0);
      return expect(TicTacToe.display.makeMove).toHaveBeenCalledWith("X", 0);
    });
    xit("should disable buttons", function() {
      TicTacToe.updateBoardHuman("X", "_________", 0);
      return expect(TicTacToe.buttonsEnabled).toBe(false);
    });
    return xit("should update the boardState", function() {
  ...
  describe("TicTacToe.updateBoardAI", function() {
    ...
    xit("should update the boardState", function() {
      TicTacToe.updateBoardAI("O", "X___O____", 4, null);
      return expect(TicTacToe.boardState).toBe("X___O____");
    });
    xit("should enable buttons again", function() {
      TicTacToe.updateBoardAI("O", "X___O____", 4, null);
      return expect(TicTacToe.buttonsEnabled).toBe(true);
    });
    xit("should display win message and form when player wins, buttons should be disabled", function() {
    ...
    xit("should display lose message and form when player loses, buttons should be disabled", function() {
      TicTacToe.updateBoardAI("X", "X_OOX_XOX", 8, "L");
      expect(TicTacToe.display.displayLoseMessage).toHaveBeenCalled();
      expect(TicTacToe.displayForm).toHaveBeenCalled();
      return expect(TicTacToe.buttonsEnabled).toBe(false);
    });
    return xit("should display tie message and form when player ties, buttons should be disabled", function() {
  ...
  describe("TicTacToe.makeMove", function() {
    ...
    return xit("should disable buttons while waiting for server, enable buttons when move is returned", function() {
      var flag;
      flag = false;
      TicTacToe.buttonsEnabled = true;
      spyOn(TicTacToe.display, "makeMove");
  ...
  describe("TicTacToe.initializeGame", function() {
    ...
    xit("should send an asynchronous POST request to / and initialize game", function() {
      var flag;
      flag = false;
      spyOn($, "ajax").andCallFake(function(params) {
        return setTimeout((function() {
    ...
    return xit("should initialize game when moving second", function() {
      var flag;
      flag = false;
      spyOn($, "ajax").andCallFake(function(params) {
        return setTimeout((function() {
